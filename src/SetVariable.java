...
public class SetVariable {
	 ...
	 */
	private ArrayList<Integer> lower_bound;
	
	/**
	 * The list of integers that <em>might</em> be in the set variable.
	 */
	private ArrayList<Integer> upper_bound;
	 ...
	 */
	private ArrayList<Integer> default_lower_bound;
	
	/**
	 * The initial list of integers that <em>might</em> be in the set variable.
	 */
	private ArrayList<Integer> default_upper_bound;
	...
	/**
	 * Creates a new {@code SetVariable} instance associated with the given default lower and upper bounds.
	 *
	 * @param default_lower_bound The ArrayList of minimum integers that must be in the set variable
	 * @param default_upper_bound The ArrayList of maximum integers that might be in the set variable
	 * @param default_min_cardinality The minimum number of integers that must be in the set variable
	 * @param default_max_cardinality The maximum number of integers that might be in the set variable
	 */
	public SetVariable(ArrayList<Integer> default_lower_bound, ArrayList<Integer> default_upper_bound, int default_min_cardinality, int default_max_cardinality) {
		
		this.lower_bound = new ArrayList<Integer>(default_lower_bound);
		this.upper_bound = new ArrayList<Integer>(default_upper_bound);
	...
	/** 
	 * Try removing the given integer from the lower bound and return whether or not the integer has been removed. 
	 * 
	 * @param variable The integer variable to remove from the lower bound
	 * @return True if the given integer has been removed from the lower bound, false otherwise
	 */
	...
	/** 
	 * Try removing the given integer from the upper bound and return whether or not the integer has been removed. 
	 * 
	 * @param variable The integer variable to remove from the upper bound
	 * @return True if the given integer has been removed from the upper bound, false otherwise
	 */
	...
	/** 
	 * Try adding the given integer to the lower bound and return whether or not the integer has been added. 
	 * 
	 * @param variable The integer variable to add to the lower bound
	 * @return True if the given integer has been added to the lower bound, false otherwise
	 */
	...
	/** 
	 * Try adding the given integer to the upper bound and return whether or not the integer has been added. 
	 * 
	 * @param variable The integer variable to add to the upper bound
	 * @return True if the given integer has been added to the upper bound, false otherwise
	 */
	...
	public boolean increase_min_cardinality(int delta) {
		// Check assertions
		if (delta < 0) {
			throw new ArithmeticException("\n$ delta = "+delta+". Parameter 'delta' must be non-negative because min_cardinality can only be increased.");
		}
		// Body
		else {
	...
	public boolean decrease_max_cardinality(int delta) {
		// Check assertions
		if (delta > 0) {
			throw new ArithmeticException("\n$ delta = "+delta+". Parameter 'delta' must be negative or null because max_cardinality can only be decreased.");
		}
		// Body
		else {
